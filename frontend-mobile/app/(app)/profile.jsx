                        ...
                        >
                            {prefsLoading ? (
                                ...
                                <View style={{ alignItems: 'center' }}>
                                    ...
                                    <Text style={[styles.mutedText, { textAlign: 'center', marginBottom: 16 }]}>You haven't taken the preference test yet.</Text>
                                    <Button label="Take the Test" onPress={() => router.push('/(app)/preferences')} color="#10B981" />
                                </View>
                            ) : (
                                <View>
                                    <Text style={{ fontSize: 13, color: '#64748B', marginBottom: 12 }}>Your matching priorities</Text>
                                    {Object.entries(prefs.tags).map(([key, val]) => (
                                        <View key={key} style={styles.tagWrap}>
                                            <View>
                                                <Text style={styles.tagLabel}>{key.toUpperCase()}</Text>
                                                <Text style={styles.tagVal}>{val}</Text>
                                            </View>
                                        </View>
                                    ))}
                                </View>
