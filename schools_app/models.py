...
class School(models.Model):
    ...
    # Aspect-Based Sentiment scores (averages from all reviews, range roughly -1.0 to 1.0)
    teachers_score = models.FloatField(default=0.0, help_text='Average teachers aspect score')
    facilities_score = models.FloatField(default=0.0, help_text='Average facilities aspect score')
    administration_score = models.FloatField(default=0.0, help_text='Average administration aspect score')
    affordability_score = models.FloatField(default=0.0, help_text='Average affordability aspect score')
...
class Comment(models.Model):
    ...
    sentiment = models.CharField(
        ...
        default='neutral',
        blank=True,
        help_text='LLM-classified sentiment: good, bad, or neutral',
    )

    # Aspect-Based Sentiment scores: 1=positive, 0=neutral, -1=negative
    teachers_score = models.IntegerField(default=0)
    facilities_score = models.IntegerField(default=0)
    administration_score = models.IntegerField(default=0)
    affordability_score = models.IntegerField(default=0)
