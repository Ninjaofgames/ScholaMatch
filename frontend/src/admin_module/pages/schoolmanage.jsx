...
export default function SchoolManagement(){
    ...
    const handleAddSubmit = async () => {
        try {
            ...
            await adminApi.post("http://127.0.0.1:8000/admin-api/schools/", formData);
    ...
    const handleSearch = async () => {
        try {
            const response = await adminApi.get(`http://127.0.0.1:8000/admin-api/schools/${searchId}/`);
    ...
    const handleModifySubmit = async () => {
        try {
            ...
            await adminApi.put(`http://127.0.0.1:8000/admin-api/schools/${searchId}/`, formData);
    ...
    const handleDeleteSubmit = async () => {
        try {
            await adminApi.delete(`http://127.0.0.1:8000/admin-api/schools/${deleteId}/`);
