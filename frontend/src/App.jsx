...
function AppLayout() {
  ...
  const isUserPage = location.pathname === '/' || location.pathname.startsWith('/school/') || location.pathname === '/user_profile' || location.pathname === '/preferences' || location.pathname === '/welcome';
